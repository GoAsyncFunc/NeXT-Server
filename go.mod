module github.com/GoAsyncFunc/NeXT-Server
...
replace github.com/xtls/xray-core v1.251202.0 => github.com/GoAsyncFunc/Xray-core v0.0.0-20251210071729-a610a4c89ac7
