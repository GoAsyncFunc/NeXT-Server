...
import (
	...
	"github.com/GoAsyncFunc/NeXT-Server/limiter"
	"github.com/GoAsyncFunc/NeXT-Server/node"
...
func serverHandle(_ *cobra.Command, _ []string) {
	...
	limiter.Init()
	log.Info("Start V2bX...")
	vc, err := vCore.NewCore(c.XrayConfig, &c.LogConfig)
	if err != nil {
